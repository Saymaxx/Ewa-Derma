...
async function main() {
    ...
    const usersData = [
        ...
        },
        {
            ...
            role: client_1.RoleName.RECEPTIONIST,
            phone: '0120-5244840',
        },
        {
            ...
            firstName: 'Pharmacy',
            lastName: 'Manager',
            role: client_1.RoleName.INVENTORY_MANAGER,
            phone: '9876543212',
        },
    ];
